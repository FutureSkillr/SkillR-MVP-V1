...
printf "${GREEN}╠──────────────────────────────────────────────────────────────╣${NC}\n"
printf "${GREEN}║${NC}  ${DIM}Remaining steps:${NC}                                              ${GREEN}║${NC}\n"
printf "${GREEN}║${NC}    1. Run 'make ship' — authorized domains added auto        ${GREEN}║${NC}\n"
printf "${GREEN}║${NC}       (or run: make setup-oauth-domains)                     ${GREEN}║${NC}\n"
